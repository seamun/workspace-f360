...
cprequire_test(["inline:com-chilipeppr-workspace-f360"], function(ws) {
    ...
    $('title').html("f360 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-f360", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-f360", // Make the id the same as the cpdefine id
        name: "Workspace / F360", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for Fusion 360.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a f360
