# com-chilipeppr-workspace-f360
A ChiliPeppr Workspace for Fusion 360.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / F360
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-f360 |
| Name                  | Workspace / F360 |
| Description           | A ChiliPeppr Workspace for Fusion 360. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/seamun/workspace-f360/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/cmunier/workspace-f360 |
| Github URL            | http://github.com/seamun/workspace-f360 |
| Test URL              | https://preview.c9users.io/cmunier/workspace-f360/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/seamun/workspace-f360/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-f360"], // the id you gave your workspace
      function(myWorkspaceF360) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / F360 just got loaded.", myWorkspaceF360);
        myWorkspaceF360.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-f360"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / F360"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace for Fusion 360."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/seamun/workspace-f360/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/cmunier/workspace-f360"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/seamun/workspace-f360"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-f360-cmunier.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>loadTemplateWidget</td><td>function</td><td>function (callback) <br><br>Load the Template widget via chilipeppr.load() so folks have a f360
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadLuaEditorWidget</td><td>function</td><td>function (callback) <br><br>Load the Lua Editor widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
